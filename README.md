...
### GET /count
Example: tally the number of unique user Ids in the JSON and return in a JSON response 
```
curl http://localhost:8080/count -H 'Content-Type: application/json'
```
```
{
    "count": 10
...
Example: update the fourth element of the JSON feed
```
curl -X PUT http://localhost:8080/update/3 -d '{ "userId": 0, "id": 0, "title": "1800Flowers", "body": "1800Flowers"}' -H 'Content-Type: application/json' 
```
```
[
    {
